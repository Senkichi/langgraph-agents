"""Experiment 2E eval — anonymization toggle.

Filters corpus to 3 complex tasks, points run_eval machinery at the 2E
matrix dir. C(2, 2) = 1 pair × 3 tasks × 2 judges × 2 orderings = 12 LLM
calls.

Run:     uv run --active python run_eval_2e.py
Resume:  Same command.
"""
...
run_eval.MATRIX_DIR = Path("logs/matrix_2e_anon")
run_eval.EVAL_DIR = Path("logs/eval_2e")
